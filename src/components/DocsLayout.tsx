            ...
            <main className="flex-1 overflow-y-auto p-4 bg-base-200 prose lg:prose-md m-auto max-w-4xl mx-auto">
                <div className="text-sm breadcrumbs">
                    <ul>
                        ...
                        <li>
                            <a>
                                <HiOutlineDocumentText className='mx-2' />{activeDoc.title}
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <div className='flex flex-1 flex-col mt-4'>
                    <small><Link href={`https://github.com/unlimitedsoftwareworks/tc-docs/tree/master/${activeDoc.name}.mdx`} target='_blank' className="link link-hover flex flex-1 flex-row items-center">Suggest an Edit on Github <FaEdit className='mx-2' /></Link></small>
                    <small><Link href={`https://github.com/unlimitedsoftwareworks/tc-docs/issues/new?title=Feedback for page ${activeDoc.name}.mdx&labels=feedback`} target="_blank" className="link link-hover flex flex-1 flex-row items-center">Submit feedback via Github <MdOutlineFeedback className='mx-2' /></Link></small>
                </div>
            </main>
        </div>
